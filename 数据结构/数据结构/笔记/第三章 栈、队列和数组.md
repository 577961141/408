...
- 牺牲一个单元来区分队空和队满，入队时少用一个队列单元，这是一种较为普遍的做法。约定以“队头指针在队尾的下一个位置作为队满的标志”，如下所示。
    ...
    代码详见：/数据结构/数据结构/源码/第三章 栈和队列/Squeue1.c
...
- 类型中增设tag数据成员，以区分队满还是队空。tag等于0时，若因删除导致Q.front==Q.rear,则为队空；tag等于1时，若因插入导致Q.front==Q.rear，则为队满
    代码详见：代码详见：/数据结构/数据结构/源码/第三章 栈和队列/Squeue3.c
...
2. 链式队列的基本操作
    ...
    带头结点的操作详见：/Users/dongfangjingxu/Documents/learn-corrleation/408/数据结构/数据结构/源码/第三章 栈和队列/LinkQueue1.c
