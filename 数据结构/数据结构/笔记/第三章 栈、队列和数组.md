...
一、选择题
```php
1.A 2.C 3.B 4.C 5.A 6.A 7.D 8.C 9.D 10.A 11. 12.D 13.D 14.B 15.B 16.C 17.c 18.D 19.A 20.B 21.A 22.C 23.D 24.B 25.B 26.A 27.B 28.D 29.D
```
二、综合应用题

1. 答：三种；分别是：CDBAE、CDEBA、CDBEA
2. 答：B、C、A、E、D可以。D、B、A、C、E不行，原因：栈是先进先出的，如果D先出栈，这是后栈里面有ABC三个数据元素在里面了，那么C的出栈顺序一定在B与A之前
3. 1）ACD
4. 1
